...
public class TheApp {
    ...
    public static void main(String[] args) {
        ...
        //try to create an instance of Asset
        //it is abstract now - so it cannot be instantiated
//        Asset asset = new Asset();
        ...
        //cash assets
        miAssets.add(new Cash("Piggy Bank", "2014-11-28", 5383));
        miAssets.add(new Cash("Cookie Jar Stash", "2020-06-17", 3578));
        miAssets.add(new Cash("Cereal Box Stash", "2025-01-01", 1784));
        ...
        for (Asset asset : miAssets) {
            ...
            if (asset instanceof House) {
                ...
                System.out.printf("   " +
                        "Condition      : %s%n", House.getConditionInfo(house.getCondition()));
            ...
            //or the cold hard cash you've been stashing away
            else if (asset instanceof Cash) {
                System.out.printf("\uD83D\uDCB5 Asset Type     : Cash%n");
            }
            System.out.println("══════════════════════════════════════════════════════════");
        }
    }
